    ...
    public void finalAnimation(View view, int div){
        ...
        */
        ...
        for(int i = 0; i < div; i++) {
            ...
            ObjectAnimator oa_left2 = ObjectAnimator.ofFloat(imageviewList[i], "translationX", 0, rowSize/2);
        ...
        for(int i = 0; i < div; i++){
            ...
            ObjectAnimator oa_right2 = ObjectAnimator.ofFloat(imageviewList[totalImageNum - i - 1], "translationX", 0, -rowSize/2);
